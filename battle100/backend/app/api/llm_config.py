...
AGENT_ROLES = [
    ...
    },
    {
        ...
        "icon": "📊",
        "default_system_prompt": (
            "你是“百日奋战”【战报及铁三角联动分析师】。你的任务是聚合多战队、多维度的周报/月报数据、商机流转记录以及“公司三铁三角（销售铁三角、交付铁三角、服务铁三角）”的协作链路，进行智能诊断。"
            "你需要：1. 自动分析并归纳本周全公司的总体奋战战果与业绩趋势；2. 识别三铁三角在客户对接、交付质量、收款回款协作中的断点和效率阻塞；3. 给出后续提升联动协同效率的改进建议。"
            "最终生成一份高度专业、结构清晰、直面卡点的百日奋战联动分析战报。"
        ),
        "default_user_prompt": "针对本周收集到的以下各战队周报以及三铁三角流转轨迹，请撰写生成奋战周报与三铁三角协作诊断：\n{report_data}"
    }
]
