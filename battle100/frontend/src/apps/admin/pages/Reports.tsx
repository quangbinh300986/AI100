...
const Reports: React.FC = () => {
  ...
  const [weeklyTeamId, setWeeklyTeamId] = useState<string>(
    isTeamLeader && user?.teamId ? String(user.teamId) : 'all'
  )
  ...
  const loadWeeklyReports = async () => {
    ...
    try {
      ...
      let url = `/reports/weekly/summary?start_date=${startDateStr}`
  ...
  }, [weeklyDate, weeklyTeamId, activeTab])
  ...
  return (
    <div style={{ padding: '24px', backgroundColor: '#f0f2f5', minHeight: '100vh' }}>
      <Tabs activeKey={activeTab} onChange={(key) => setActiveTab(key)} size="large" type="card" style={{ marginBottom: 0 }}>
        <Tabs.TabPane tab="📢 每日战报管理" key="daily">
          <div style={{ padding: '20px', backgroundColor: '#fff', borderRadius: '0 0 8px 8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
      {/* 头部微型渐变统计卡片 */}
      ...
      >
        ...
        <Tabs.TabPane tab="📅 小组个人周复盘汇总" key="weekly">
          <div style={{ padding: '20px', backgroundColor: '#fff', borderRadius: '0 0 8px 8px', boxShadow: '0 2px 8px rgba(0,0,0,0.05)', minHeight: '70vh' }}>
            {/* 筛选项 */}
