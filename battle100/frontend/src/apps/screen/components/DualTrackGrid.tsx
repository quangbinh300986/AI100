          ...
          return (
            <div
              ...
              style={{
                ...
                borderRadius: '8px',
                padding: '0.35rem', // 极度压缩内部 padding
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        display: 'flex',
                        flexDirection: 'column',
                        justifyContent: 'space-between', // 让内容在纵向均匀分布
                        padding: '0.4rem 0.55rem', // 压缩战队卡片 padding
                    ...
                    >
                      ...
                      {/* 队长/巴长名字 */}
                      <div style={{ fontSize: '0.85rem', color: '#666666', marginBottom: '0.2rem' }}>
