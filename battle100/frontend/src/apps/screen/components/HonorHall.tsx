      ...
      <div style={{
        ...
        <div className="screen-card scroll-paper" style={{
          ...
          <div>
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', margin: '0.15rem 0' }}>暂无战队达成挑战目标，大家继续冲刺！</div>
            <div style={{ color: '#d48806', fontWeight: 'bold', fontSize: '0.85rem' }}>授予流动红旗</div>
          </div>
        </div>
        ...
        <div className="screen-card scroll-paper" style={{
          ...
          <div>
            ...
            <div style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', margin: '0.15rem 0' }}>已斩获百万/五十万级攻坚项目 0 个，每个即时奖励 1888 元</div>
            <div style={{ color: '#f5222d', fontWeight: 'bold', fontSize: '1rem' }}>+ ¥0</div>
          </div>
        </div>
      </div>
    </div>
